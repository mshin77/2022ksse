...
<h4> `r fontawesome::fa("github", "black")` &nbsp; [github.com/mshin77/2022ksse](https://github.com/mshin77/2022ksse) &nbsp;
`r fontawesome::fa("home", "black")` &nbsp; [mshin77.net](https://mshin77.net) </h4>
...
[(Hamaker외, 2021)](https://ellenhamaker.github.io/DSEM-book-chapter/MLM1to6.html#Multilevel_Model_1){style="font-size: 0.85em"}  ![](https://ellenhamaker.github.io/DSEM-book-chapter/images/MLM0.jpg){height="400"} 
...
* [단일대상 실험설계 데이터만 포함]{style="background-color: yellow"}하여 한 단계로 메타분석 실시. 
...
[Shin, M., Park, J., Grimes, R., & Bryant, D. P. (2021). Effects of using virtual manipulatives for students with disabilities: Three-level multilevel modeling for single-case data. *Exceptional Children, 87*(4), 418–437.]{style="font-size: 0.85em"}  
...
[`library(nlme)`](https://cran.r-project.org/web/packages/nlme) R 패키지 lme() 함수 활용 <br>
[`분석 데이터 다운로드`](https://osf.io/wvtxg/files/osfstorage) <br>
조절 변수 포함하지 않음 
...
- [단일대상 실험설계 또는 단일대상과 집단 실험설계 연구 데이터를 모두 포함]{style="background-color: yellow"}하여 두 단계로 메타분석 실시. 

- [`library(nlme)`](https://cran.r-project.org/web/packages/nlme) lme() 함수 --> [`library(metafor)`](https://cran.r-project.org/web/packages/metafor/index.html) rma.mv() 함수 -->
[`library(clubSandwich)`](https://cran.r-project.org/web/packages/clubSandwich/index.html)
<br>
![](https://github.com/mshin77/2022ksse/blob/main/figures/figma.png?raw=true){width="1000"}

---

- `사례 1.` 단일대상 연구만 포함하여 2수준 다층 분석 후 메타분석 <br>
    - [Shin, M., Bryant, D. P., Powell, S. R., Jung, P. G., Ok, M. W., & Hou, F. (2021). A meta-analysis of single-case research on word-problem instruction for students with learning disabilities. *Remedial and Special Education, 42*(6), 398-411]{style="font-size: 0.85em"} <br>
[`분석 데이터 다운로드`](https://osf.io/xr58s/files/osfstorage) <br>

- `사례 2.` 단일대상과 집단 연구 각각 2수준 다층 분석 실시 후 함께 메타분석 <br>
    - [Kim, S. A., Bryant, D. P., Bryant, B. R., Shin, M., & Ok, M. W. (2022). A Multilevel Meta-Analysis of Whole Number Computation Interventions for Students With Learning Disabilities. *Remedial and Special Education*. Advance online publication.]{style="font-size: 0.85em"} <br>
[`분석 데이터 다운로드`](https://osf.io/wuk5p/files/osfstorage) 

---

## `오픈 소스 기반의 무료 웹 애플리케이션` 
...
- [`library(lme4)`](https://cran.r-project.org/web/packages/lme4) R 패키지 lmer() 함수 활용 <br>
...
- [`library(nlme)`](https://cran.r-project.org/web/packages/nlme) R 패키지 lme() 함수 <br>

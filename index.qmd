...
[(Hamaker외, 2021)](https://ellenhamaker.github.io/DSEM-book-chapter/MLM1to6.html#Multilevel_Model_1) ![](https://ellenhamaker.github.io/DSEM-book-chapter/images/MLM0.jpg){height="400"} 
...
[`library(nlme)`](https://cran.r-project.org/web/packages/nlme){fig-align="left"} lme() 함수 <br>
[`분석 데이터 다운로드`](https://osf.io/wvtxg/files/osfstorage) 
조절 변수 포함하지 않음 
...
- Kim, S. A., Bryant, D. P., Bryant, B. R., Shin, M., & Ok, M. W. (2022). A multilevel meta-analysis of whole number computation interventions for students with learning disabilities. *Remedial and Special Education*. Advance online publication [[`분석 데이터 다운로드`].](https://osf.io/wuk5p/files/osfstorage)
...
- Shin, M., Bryant, D. P., Powell, S. R., Jung, P. G., Ok, M. W., & Hou, F. (2021). A meta-analysis of single-case research on word-problem instruction for students with learning disabilities. *Remedial and Special Education, 42*(6), 398-411 [[`분석 데이터 다운로드`].](https://osf.io/xr58s/files/osfstorage)
